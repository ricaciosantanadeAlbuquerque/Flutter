...
class MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    // a altura do dispositivo menos a altura do appBar e da barra de status
    var altura = MediaQuery.of(context).size.height - appBar.preferredSize.height - MediaQuery.of(context).padding.top;
